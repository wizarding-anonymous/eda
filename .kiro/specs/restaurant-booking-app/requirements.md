# Требования к мобильному приложению бронирования столиков

## Введение

Мобильное приложение для бронирования столиков в кафе и ресторанах предназначено для упрощения процесса поиска заведений, бронирования столиков с возможностью предзаказа блюд и оплаты через QR-код. Приложение направлено на повышение заполняемости ресторанов, уменьшение количества "no-show" и улучшение взаимодействия между гостями и заведениями.
...
4. WHEN пользователь выбирает вход через социальные сети THEN система SHALL поддерживать VK, Яндекс, Google и Apple
...
### Требование 12: Безопасность и соответствие законодательству
