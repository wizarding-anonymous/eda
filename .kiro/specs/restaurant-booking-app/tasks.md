# План реализации мобильного приложения бронирования столиков
...
- [ ] 5. Система QR-оплаты
  - [ ] 5.1 Реализовать QR-сканер
    - Интегрировать mobile_scanner для сканирования QR
    - Создать экран сканера с подсветкой и фонариком
    - Добавить обработку QR-токенов столиков
    - Реализовать fallback для ручного ввода кода
    - _Требования: 4.1_

  - [ ] 5.2 Создать систему оплаты по QR
  ...
  - [ ] 5.3 Интегрировать платежи и чеки
...
- [ ] 6. Профиль пользователя и история
  - [ ] 6.1 Создать экран профиля
  ...
  - [ ] 6.2 Реализовать историю бронирований
...
- [ ] 9. Программы лояльности и промокоды
...
- [ ] 10. Функции для заведений (админ панель)
...
- [ ] 11. Безопасность и соответствие законодательству
...
- [ ] 13. Подготовка к релизу
  ...
  - [ ] 13.2 Подготовить сборки для сторов
    - Настроить CI/CD пайплайны
    - Создать релизные конфигурации
